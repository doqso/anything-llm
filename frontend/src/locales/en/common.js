const TRANSLATIONS = {
  ...
  connectors: {
    ...
    directory: {
      ...
      watch_selected: "Watch",
      unwatch_selected: "Unwatch",
      watching_selected: "Watching selected documents",
      unwatching_selected: "Unwatching selected documents",
      watch_selected_success: "Watching {{count}} selected document(s).",
      unwatch_selected_success: "Stopped watching {{count}} selected document(s).",
      watch_selected_failed: "Failed to update selected document watch status.",
